...
type Observation struct {
	...
	ScheduledDate  helpers.DateOnly `json:"scheduled_date" gorm:"type:date;not null"`
	AgeCategory    string           `json:"age_category" gorm:"type:enum('Balita', 'Anak-anak', 'Remaja', 'Lainnya');not null"`
