...
type Children struct {
	...
	ParentId           string    `json:"father_id" gorm:"type:char(26);not null;index"`
	...
	ChildBirthDate     time.Time `json:"child_birth_date" gorm:"type:date;not null"`
	ChildAge           int       `json:"child_age" gorm:"type:int;not null"`
