...
type resendVerificationAccountUseCase struct {
	deps *Dependencies
}

func NewResendVerificationAccountUseCase(deps *Dependencies) ResendVerificationAccountUseCase {
	return &resendVerificationAccountUseCase{deps: deps}
}

func (uc *resendVerificationAccountUseCase) Execute(ctx context.Context, req *dto.ResendTokenRequest) error {
